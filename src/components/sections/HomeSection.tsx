...
import { Mail, FolderOpen, User, Send } from 'lucide-react';
  ...
  return (
    <div className="line-numbers animate-fade-in">
      ...
      <div className="line pl-8">
        <span className="text-accent-pink font-display text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight">
          {lastName}
        </span>
      ...
      <div className="line pl-8 flex flex-wrap gap-3 py-3">
        <Link
          href="/projects"
          className="inline-flex items-center gap-2 px-4 py-2 bg-accent-pink text-white text-xs font-mono rounded-sm hover:brightness-110 transition-all"
        >
          <FolderOpen size={14} />
          Projects
        </Link>
        <Link
          href="/about"
          className="inline-flex items-center gap-2 px-4 py-2 border border-border text-text-primary text-xs font-mono rounded-sm hover:bg-bg-tab transition-colors"
        >
          <User size={14} />
          About Me
        </Link>
      ...
      <div className="line pl-8 flex flex-wrap gap-3 py-3">
        <a
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-mono text-text-muted hover:text-text-primary border border-border rounded-sm hover:bg-bg-tab hover:border-accent-cyan transition-all"
        >
          <GithubIcon size={14} />
          GitHub
        </a>
